  ...
  _.merge(
    {
      ...
      fieldsPanelDefaultOpeneds: {
        type: Array,
        default: () => ['field', 'container', 'defaultField'],
      },
      delHandle: {
        type: Function,
        default: () => {},
...
<template>
  ...
  >
    <template v-slot:header>
      <DeviceSwitch
        :modelValue="previewPlatform"
        @update:modelValue="(val) => handleOperation(7, val)"
      ></DeviceSwitch>
    </template>
    <el-scrollbar>
      <div
        ...
        :class="[
          ns.e('previewDialogWrap'),
          previewPlatform === 'mobile' && ns.is('mobilePreview'),
        ]"
      >
